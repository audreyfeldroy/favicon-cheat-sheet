...
* Create a favicon.ico using ImageMagick with all resolutions specified in this cheat sheet and merge them all into one multi-framed non-transparant favicon.ico, just the way all browsers and devices like it. (thanks to cappie2000 on Stackoverflow)

    .. code-block:: bash
    
        $ convert favicon-256x256.png -bordercolor white -border 0 \
